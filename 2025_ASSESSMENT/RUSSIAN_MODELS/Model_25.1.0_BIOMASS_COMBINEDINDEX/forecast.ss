...
0.35 # Biomass target (e.g. 0.40) as fraction of SSB_virgin if depletion basis = 1, else as fraction of SSB_unfished in benchmark
...
#  1977 2022 1977 2022 1977 2022 1977 2022 1977 2022
...
# Factor method st_yr end_yr 
 10 1 -5 0 # selectivity; use:  10 1 -5 0
 11 1 -5 0 # rel_F; use:  11 1 -5 0
 12 1 -999 -2 # recruitment; use:  12 1 -999 -2
-9999 0 0 0
#
...
0.02 # Control rule cutoff for no F (as frac of HCR_anchor, e.g. 0.10) 
...
4 # Forecast base recruitment:  0= spawn_recr; 1=mult*spawn_recr_fxn; 2=mult*VirginRecr; 3=deprecated; 4=mult*mean_over_yr_range
...
# enter list of:  season, fleet, area, relF; if used, terminate with season=-9999
# 1 1 0.75
# 1 3 0.24
# 1 4 0.01
