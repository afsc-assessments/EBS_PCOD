...
#C file write time: 2023-10-08 14:25:23
BSPcod24_OCT_5cm_NB_COMBO_RV.dat #_datfile
Model_24.1.ctl #_ctlfile
...
20 #_last_estimation_phase:  turn off estimation for parameters entering after this phase
#
0 #_MCMCburn
2 #_MCMCthin
0 # jitter_fraction:  jitter within parameter bounds
-1 #_minyr_sdreport:  min year for sdreport outputs (-1 for styr); #_1975
-2 #_maxyr_sdreport:  max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2039
...
6 #_depl_basis:  Depletion denom is: 0=skip; 1=X*SSB_virgin; 2=X*SSB_msy; 3=X*SSB_styr; 4=X*SSB_endyr; 5=X*dyn_Bzero; 6=X*SSB_unf_bmark; values>=11 invoke N multiyr with 10s & 100s digit; append .1 to invoke log(ratio); e.g. 122.1 produces log(12 yr trailing average of B/Bmsy)
# If value = 1, then Btarget in benchmark will be a fraction of SSB_virgin, else will be a fraction of SSB_benchmark
1.0 #_depl_denom_frac:  fraction (X) for Depletion denominator (e.g. 0.4)
...
1634588875 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1634588875
