...
# Sex: 1  BioPattern: 1  Growth
 1 20 13.8833 14.7724 0.244395 0 2 0 5 2001 2024 7 0 0 # L_at_Amin_Fem_GP_1
 60 150 113.114 112.958 5.92116 0 10 0 0 0 0 0 0 0 # L_at_Amax_Fem_GP_1
 0 1 0.109581 0.109893 0.0208198 0 2 0 5 2001 2024 7 0 0 # VonBert_K_Fem_GP_1
...
1 # (0/1) to read 13 advanced options
 ...
 1997.2 #_first_yr_fullbias_adj_in_MPD; begin of plateau
 2022.0 #_last_yr_fullbias_adj_in_MPD
 2039.2 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS3 sets bias_adj to 0.0 for fcast yrs)
 0.9334 #_max_bias_adj_in_MPD (typical ~0.8; -3 sets all years to 0.0; -2 sets all non-forecast yrs w/ estimated recdevs to 1.0; -1 sets biasadj=1.0 for all yrs w/ recdevs)
...
#_ LO HI INIT PRIOR PR_SD  PR_type  PHASE
 ...
 0 1 0.0197044 0 0 0 6 # InitF_seas_1_flt_3russia
 0 1 0.0196645 0 0 0 6 # InitF_seas_1_flt_4goa
#
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
# 1   fishery LenSelex
            10            80       74.7109          -999          -999             0          3          0          0       2001       2024          8          0          0  #  Size_DblN_peak_fishery(1)
           -10            10            10          -999          -999             0         -3          0          0          0          0          0          0          0  #  Size_DblN_top_logit_fishery(1)
           -10            10       5.96776          -999          -999             0          3          0          0       2001       2024          8          0          0  #  Size_DblN_ascend_se_fishery(1)
           ...
           -10            10            10          -999          -999             0         -3          0          0       2001       2024          8          0          0  #  Size_DblN_end_logit_fishery(1)
# 2   survey LenSelex
            10            80       22.4713          -999          -999             0          3          0          0       2001       2024          0          0          0  #  Size_DblN_peak_survey(2)
           -10            10            10          -999          -999             0         -3          0          0          0          0          0          0          0  #  Size_DblN_top_logit_survey(2)
           -10            10       4.00051          -999          -999             0          3          0          2       2001       2024          3          0          0  #  Size_DblN_ascend_se_survey(2)
...
# 3   russia LenSelex
# 4   goa LenSelex
            10            80       65.7636          -999          -999             0          3          0          0       2001       2024          8          0          2  #  Size_DblN_peak_goa(4)
           -10            10            10          -999          -999             0         -3          0          0          0          0          0          0          0  #  Size_DblN_top_logit_goa(4)
           -10            10       5.37717          -999          -999             0          3          0          0       2001       2024          8          0          2  #  Size_DblN_ascend_se_goa(4)
           ...
           -10            10            10          -999          -999             0         -3          0          0       2001       2024          8          0          0  #  Size_DblN_end_logit_goa(4)
# 1   fishery AgeSelex
# 2   survey AgeSelex
# 3   russia AgeSelex
# 4   goa AgeSelex
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type    PHASE  #  parm_name
 ...
 #          -10            10        6.4736          -999          -999             0      3  # Size_DblN_ascend_se_fishery(1)_BLK4repl_1977
  ...
  #          10            80       70.9385          -999          -999             0      3  # Size_DblN_peak_goa(4)_BLK5repl_1977
  #        -10            10       5.41305          -999          -999             0      3  # Size_DblN_ascend_se_goa(4)_BLK5repl_1977
