...
F_LIMIT_BASIS<-paste0("'F from ",endyr-1," asmt corresponding to specified ",endyr-2," OFL'") 
...
GET_SARA_ENSEMBLE(dir=getwd(),models=mods,nam_mod=mods_nam,WEIGHT=WT,email="'steve.barbeaux@noaa.gov'",Enter_Data=FALSE,STOCK="EBS PCOD",STOCK_NAME="'Pacific cod'",REGION="'EBS'",TIER="'3b'",UPDATE="'benchmark'",COMPLEX="'NA'",CID=5,AID=5,BID=3,SCID=5,EL=2,MFR=1000,F_LIMIT=0.324, SURV_DESC="'EBS Slope Bottom trawl survey'",NOTES="'2022 New Series Ensemble.'",stryr=1977)
