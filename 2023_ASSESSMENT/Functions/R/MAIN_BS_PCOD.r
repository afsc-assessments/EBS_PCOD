...
libs <- c("tidyverse", "dplyr","RODBC","mgcv","FSA","nlstools","data.table","ggplot2","sizeMat","devtools","r4ss","lubridate","rgdal","fishmethods","reshape2","swo","vcdExtra","misty","tidyr")
...
working_dir <- "C:/WORKING_FOLDER/EBS_PCOD/2024_ASSESSMENT"
...
source_files=c("BIN_LEN_DATA.r","FORMAT_AGE_MEANS1.r", "cond_length_age_corFISH.r","GET_DOM_AGE.r","GET_BS_ACOMP1.r","GET_BS_BIOM.r","GET_BS_LCOMP1.r",             
