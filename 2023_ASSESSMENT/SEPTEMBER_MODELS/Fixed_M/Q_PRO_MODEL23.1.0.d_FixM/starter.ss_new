...
#C file write time: 2023-07-26 16:10:33
BSPcod22_OCT.dat
control_modified.ss
...
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2037
...
2.5 # Fraction (X) for Depletion denominator (e.g. 0.4)
...
1634588875 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1634588875
