GET_SARA_ENSEMBLE<-function(dir=getwd(),models=mods,nam_mod=mods_nam,WEIGHT=WT,email="'steve.barbeaux@noaa.gov'",Enter_Data=FALSE,STOCK="EBS PCOD",STOCK_NAME="'Pacific cod'",REGION="'EBS'",TIER="'3b'",UPDATE="'benchmark'",COMPLEX="'NA'",CID=5,AID=5,BID=3,SCID=5,EL=2,MFR=1000,F_LIMIT=0.324, F_MSY_PROJ=0.2, SURV_DESC="'EBS Slope Bottom trawl survey'",NOTES="'2022 New Series Ensemble.'",stryr=1977,SS3_proj=TRUE)
{
  ...
  data<-SSgetoutput(dirvec=models)
...
F_MSY<-sum(F_MSY)
  ...
  write(x=noquote(prolog),file=paste(getwd(),"/",STOCK,".dat",sep=""),ncolumns=45)
...
GET_SARA_ENSEMBLE(dir=getwd(),models=mods,nam_mod="Model 23.1.0.d",WEIGHT=1,email="'steve.barbeaux@noaa.gov'",Enter_Data=FALSE,STOCK="EBS PCOD",STOCK_NAME="'Pacific cod'",REGION="'EBS'",TIER="'3a'",UPDATE="'benchmark'",COMPLEX="'NA'",CID=5,AID=5,BID=3,SCID=5,EL=2,MFR=1000,F_LIMIT=0.324, F_MSY_PROJ=0.2, SURV_DESC="'EBS Slope Bottom trawl survey'",NOTES="'2023 Model 23.1.0.d'",stryr=1977,SS3_proj=TRUE)
